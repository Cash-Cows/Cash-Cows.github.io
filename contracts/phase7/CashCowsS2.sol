...
import "./CashCowsS2Abstract.sol";

/**
 * @dev Specifics of the Cash Cows Season 2 collection
 */
contract CashCowsS2 is ReentrancyGuard, CashCowsS2Abstract { 
  // ============ Constants ============
  ...
  constructor(
    ...
    address admin
  ) CashCowsS2Abstract(preview, admin) {}
