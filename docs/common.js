...
/***/ 9570:
/*!************************************************!*\
  !*** ./src/app/utils/connectwallet.service.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ConnectwalletService": () => (/* binding */ ConnectwalletService)
/* harmony export */ });
...
let ConnectwalletService = class ConnectwalletService {
    ...
    constructor(alertController, loadingController) {
        ...
        this.config = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.configchain;
        this.isConnected = false;
        this.ethereum.on("accountsChanged", (accounts) => (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
    ...
    init() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            ...
            const abiResponse = yield fetch(abi, {
                headers: {
                    "Content-Type": "application/json",
                    Accept: "application/json",
                },
            });
            const contractAbi = yield abiResponse.json();
            ...
            const abiResponseRoyalty = yield fetch(abiRoyalty, {
                headers: {
                    "Content-Type": "application/json",
                    Accept: "application/json",
                },
            });
            const contractAbiRoyalty = yield abiResponseRoyalty.json();
    ...
    connect() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
                ...
                const networkId = yield this.ethereum.request({
                    method: "net_version",
                });
                ...
                if (accounts.length == 0) {
                    this.setAccount(yield this.getAccount());
                }
                else {
    ...
    getAccount() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            return new Promise((resolve) => (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
                const accounts = yield this.ethereum.request({ method: 'eth_requestAccounts' });
                resolve(accounts[0]);
            }));
        });
    }
...
ConnectwalletService.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__.AlertController },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__.LoadingController }
];
ConnectwalletService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/***/ 3911:
/*!************************************************!*\
  !*** ./src/app/utils/toast-message.service.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let ToastMessageService = class ToastMessageService {
    ...
    presentToast(msg, duration = 6000) {
    ...
    errorAlert(message) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                ...
                buttons: [{
                        text: 'Ok',
                        handler: () => (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
                            window.location.reload();
                        })
                    }
                ]
...
/* harmony export */ });
/* harmony import */ var D_Github_NFT_cashcows_Cash_Cows_github_io_website_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,D_Github_NFT_cashcows_Cash_Cows_github_io_website_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,D_Github_NFT_cashcows_Cash_Cows_github_io_website_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,D_Github_NFT_cashcows_Cash_Cows_github_io_website_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,D_Github_NFT_cashcows_Cash_Cows_github_io_website_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
